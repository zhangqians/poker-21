 ...
 */
'use strict';
let {formatInputs, getNormalPoints, getAllPoints, comparePoints, formatInput_s, getNormalPoint_s, getAllPoint_s, poker}=require('../src/poker.js');
...
describe('poker.js', function () {
    ...
    it('should print format points inputs', ()=> {
        ...
        let builtFormatPoints = formatInput_s(inputs);
    ...
    it('should print normal points', ()=> {
        let inputs = ['3', 'A', 'J', '1', 'A'];
        let gotNormalPoints = getNormalPoint_s(inputs);
    ...
    it('should print all points', ()=> {
        let inputs = 22;
        let input = ['3', '4', '5', 'A', 'J'];
        let allPoints = getAllPoint_s(inputs, input);
